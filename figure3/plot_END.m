K_n = [0.15, 0.2, 0.25, 0.3, 0.35, 0.4];
MSE_beta = reshape(mean(error_est,1),[numel(K_n),6]);
R_sq = reshape(mean(r_sq_est,1),[numel(K_n),6]);
...
p5 = plot(K_n, MSE_beta(:,5), 'm-+', 'LineWidth', 1.5, 'MarkerSize',11, 'MarkerFaceColor', 'm');
p6 = plot(K_n, MSE_beta(:,6), 'c-x', 'LineWidth', 1.5, 'MarkerSize',11, 'MarkerFaceColor', 'c');
...
p5 = plot(K_n, R_sq(:,5), 'm-+', 'LineWidth', 1.5, 'MarkerSize',11, 'MarkerFaceColor', 'm');
p6 = plot(K_n, R_sq(:,6), 'c-x', 'LineWidth', 1.5, 'MarkerSize',11, 'MarkerFaceColor', 'c');
xlabel('k/n', 'FontSize', 14)
